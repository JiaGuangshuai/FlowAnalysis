...
**Version 0.1.0 is under development.** See [validation status](docs/VALIDATION.md). Implemented features do not imply numerical equivalence to every FlowJo version, plugin or instrument-specific algorithm.
